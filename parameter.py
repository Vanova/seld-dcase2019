...
def get_params(argv):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir='/home/vano/wrkdir/datasets/DCASE19_TASK_3/',  # Base folder containing the foa/mic and metadata folders
        ...
        pool_size=[5, 5, 3],        # CNN pooling, length of list = number of CNN layers, list value = pooling per layer
